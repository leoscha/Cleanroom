...
deterministic precision, required recall, span, verification, and PDF gates. The PDF
case is generated in a controlled temporary directory from synthetic content and then
removed. Text and PDF metrics are reported separately. Results are written outside
this directory to ignored `evaluation-results/`.
